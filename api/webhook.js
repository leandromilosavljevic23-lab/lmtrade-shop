...
export default async function handler(req,res){
  ...
  if(resendKey){
    ...
    await fetch("https://api.resend.com/emails",{method:"POST",headers:{"Authorization":"Bearer "+resendKey,"Content-Type":"application/json"},body:JSON.stringify({from:"LM Trade <onboarding@resend.dev>",to:[email],subject:"Dein LM Trade Zugang ist aktiv!",html})});
  }
